    ...
    class Program
    {
        ...
        */
        ...
        public static int RemoveDuplicates(int[] nums)
        {
            try
            {
                ...
                for (int i = 1; i < nums.Length; i++)
                {
                    ...
                    if (nums[i] != nums[uniqueIndex])
                    {
                        ...
                        // Update the value at uniqueIndex with the current element
            ...
            {
                // If any exception occurs during the process, rethrow it
                throw;
            }
        }
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                foreach (int num in nums)
                {
                    ...
                    if (num != 0)
                    {
                        // Add it to the result list and update the non-zero index
                        result.Add(num);
                        nonZeroIndex++;
                    }
                }

                // Add zeros to the result list to fill the remaining positions
        ...
        */
        ...
        public static IList<IList<int>> ThreeSum(int[] nums)
        {
            try
            {
                ...
                // Initialize the result list to store triplets summing up to zero
                ...
                // Return the result list containing all unique triplets summing up to zero
                return result;
            }
            catch (Exception)
            {
        ...
        */
        ...
        public static int FindMaxConsecutiveOnes(int[] nums)
        {
            try
            {
                // Initialize variables to track the maximum consecutive ones and the current consecutive ones
                ...
                foreach (int num in nums)
                {
                    ...
                    if (num == 1)
                    {
                        ...
                        // Update the maximum consecutive ones if the current count exceeds it
        ...
        */
        ...
        public static int BinaryToDecimal(int binary)
        {
            try
            {
                ...
                // Initialize the base value to 1 (corresponding to 2^0)
                int baseValue = 1;
                ...
                while (binary > 0)
                {
                    ...
                    // Divide the binary number by 10 to remove the last digit
                    binary /= 10;

                    // Update the decimal number by adding the product of the last digit and base value
        ...
        */
        ...
        public static int MaximumGap(int[] nums)
        {
            try
            {
                // If the array contains less than 2 elements, maximum gap is 0
                if (nums.Length < 2)
                    return 0;
        ...
        */
        ...
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                ...
                // Loop through the array to find the largest perimeter
                for (int i = 0; i < nums.Length - 2; i++)
                {
                    // Check if the current triplet forms a valid triangle
                    if (nums[i] < nums[i + 1] + nums[i + 2])
                    {
                        // If it forms a valid triangle, return the perimeter
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            try
            {
                ...
                while ((index = s.IndexOf(part)) != -1)
                {
                    ...
                    // `index` is the starting index of `part` in `s`
                    // `part.Length` is the length of `part` to be removed
